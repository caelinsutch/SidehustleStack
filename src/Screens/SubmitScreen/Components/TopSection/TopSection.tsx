...
const TopSection: React.FC<TopSectionProps> = (props) => (
  <Box mt={100} {...props}>
    ...
    <SubmissionInfoText>
      ...
      people to directly monetize their skills, knowledge, or creativity (e.g.
      Uber, Etsy, etc.)
    </SubmissionInfoText>
    <SubmissionInfoText>
      A <i>tool</i>, allows side hustlers to do the above better, faster, or at
      a lower cost (e.g. an audio transcriber or a new creator-first calendar
      client)
    </SubmissionInfoText>
  </Box>
);
